...
<div class="panel">
	...
	<dl class="panel-body">
		...
		<dd class="panel-col-2">
			<ul class="clearfix">
				<li>货主:<?php echo $row['username']; ?></li>
				<li>手机号:<?php echo $row['phone']; ?></li>
				<li>级别:<span class="icon-heart level-star">&#xf004;&#xf004;</span></li>
			</ul>
		</dd>
		<dt id="collapse-hd">物流信息<span class="icon-caret-down"></span></dt>
		<dd class="panel-col-3" id="collapse-bd">
			<ul class="clearfix">
				...
				<li class="panel-row-1">到达暂停线时间:<?php echo $row['pausetime']; ?></li>
				<li class="panel-row-2">暂停线车道:<?php echo $row['trackid']; ?></li>
				<li class="panel-row-1">到达货场时间:<?php echo $row['dumptime']; ?></li>
				<li class="panel-row-2">到达货场:<?php echo $row['dumpname']; ?></li>
				<li class="panel-row-2">所在装卸线:<?php echo $row['packname']; ?></li>
				<li class="panel-row-2">货位编号:<?php echo $row['goodpositionid']; ?></li>
			</ul>
		</dd>
	</dl>
</div>
