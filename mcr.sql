...
) AUTO_INCREMENT=3 DEFAULT CHARSET=gb2312;
...
CREATE TABLE `t_kind` (
  ...
  PRIMARY KEY  (`kindid`)
) AUTO_INCREMENT=7 DEFAULT CHARSET=gb2312;
...
CREATE TABLE `t_knob` (
  ...
  PRIMARY KEY  (`knobid`)
) AUTO_INCREMENT=6 DEFAULT CHARSET=gb2312;
...
) AUTO_INCREMENT=4 DEFAULT CHARSET=gb2312;
...
CREATE TABLE `t_pack` (
  ...
  PRIMARY KEY  (`packid`)
) AUTO_INCREMENT=5 DEFAULT CHARSET=gb2312;
...
CREATE TABLE `t_pause` (
  ...
  PRIMARY KEY  (`pauseid`)
) AUTO_INCREMENT=2 DEFAULT CHARSET=gb2312;
...
) AUTO_INCREMENT=21 DEFAULT CHARSET=gb2312;
...
CREATE TABLE `t_stuff` (
  ...
  PRIMARY KEY  (`stuffid`)
) AUTO_INCREMENT=12 DEFAULT CHARSET=gb2312;
